...

{
  ...
  # wayland.windowManager.hyprland.package = inputs.hyprland.packages.${pkgs.stdenv.hostPlatform.system}.hyprland;
    settings = {
      ...
      device = [
        { name = "magic-mouse-2"; sensitivity = -1; natural_scroll = true; }
        { name = "virtual-mouse"; sensitivity = -1; natural_scroll = true; }
        { name = "keychron-k3"; kb_layout = "us"; }
        { name = "keychron-keychron-k3-2"; kb_layout = "us"; }
        { name = "keychron-keychron-k3"; kb_layout = "us"; }
      ];
      ...
      bind = [
        ...
        ", XF86Tools, exec, zen --new-window www.gmail.com"
        "SUPER, F10, exec, zen --new-window 'ext+container:name=UniTN&url=www.gmail.com'"
        "SUPER SHIFT, F10, exec, zen --new-window www.outlook.it"
        "SUPER CTRL, F10, exec, zen --new-window 'ext+container:name=Tuni&url=www.outlook.it'"
